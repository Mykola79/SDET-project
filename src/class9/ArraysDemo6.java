...
public class ArraysDemo6 {
    public static void main(String[] args) {
       ...
       /*create an empty array then store 45 44 33 20 and 10 in it, then use loop to add all the elements which are
        present in even indexes and print it after adding them
        */
